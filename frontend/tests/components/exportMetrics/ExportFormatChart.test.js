...
describe('ExportFormatChart', () => {
  ...
  it('transforms analytics data into chart format correctly', () => {
    ...
    const transformDataMock = vi.spyOn(
      ExportFormatChart.methods,
      'transformFormatData'
    )
  ...
  it('handles empty format data gracefully', () => {
    ...
    expect(wrapper.find('.no-data-message').text()).toContain(
  ...
  it('formats tooltips with percentages', () => {
    ...
    const tooltipFormatter =
      wrapper.vm.chartOptions.plugins.tooltip.callbacks.label
